...
import ChoixJeux from '../ChoixJeux/ChoixJeux';
export default function Step(props) {
    ...
    return <div className='step-container'>
        <div className='sous-step'>
            <p>YOU PICKED</p>
            <div className='center-rond'>
            <ChoixJeux
                choix={props.class}
                img={props.img} />
            </div>
        </div>
        {props.verif && <div className='div-btn'>
            <p>{props.resultat}</p>
            <button onClick={props.btnClick}>PLAY AGAIN</button>
        </div>}
        <div className='sous-step'>
            <p>THE HOUSE PICKED</p>
            <div className='center-rond'>
                { props.verif ? <ChoixJeux 
                choix={props.choixOrdi}
                img={props.imgOrdi} /> : <div className='rond-noir'>
                </div> }
            </div>
        </div>
    </div>
